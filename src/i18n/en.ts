...
export const en: Record<StringKey, string> = {
  ...
  'setup.mcpStatus.active': 'MCP Server active · {url}',
  'setup.mcpStatus.inactive': 'MCP Server inactive',
  'setup.mcpToken.show': 'Show',
  'setup.mcpToken.hide': 'Hide',
  'setup.mcpCopy.url': 'Copy URL',
  'setup.mcpCopy.token': 'Copy token',
  'setup.mcpCopy.config': 'Copy JSON config',
  'setup.mcpCopy.copied': 'Copied!',
  'setup.mcpLastActivity': 'Last AI activity',
  'setup.mcpLastActivity.none': 'No query received',
  'setup.mcpPrivacyNote': 'Privacy note: NovaGuard runs all detection locally. When the MCP server is enabled, queries and media requested by your AI assistant are sent to it.',
